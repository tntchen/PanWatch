...
| [28-后续改进路线图-稳定性到产品闭环.md](28-后续改进路线图-稳定性到产品闭环.md) | 稳定性→保真→产品化排序：P0 生产基线 / P1 数据源韧性 / P2 Agent 保真 / P3 发布治理 |
| [29-运行可靠性与东芯保真实施计划.md](29-运行可靠性与东芯保真实施计划.md) | R1 Tushare 依赖 / R2 数据源熔断降级（含 07-29 纠偏）/ R3 东芯 10 日保真 / R4 发布回滚产品化 |
| [30-全量审计-20260729.md](30-全量审计-20260729.md) | 全量审计：P0 SPA 路径穿越（已修复）+ R2 两处偏差（已纠偏）+ P2 观察项登记 |
